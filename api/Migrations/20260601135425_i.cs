        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CvData = table.Column<byte[]>(type: "bytea", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "JobOffers",
                columns: new[] { "Id", "Description", "JobTitle", "Salary" },
                values: new object[,]
                {
                    { 1, "Work with ASP.NET Core, EF Core and PostgreSQL", "Backend .NET Developer", 12000 },
                    { 2, "Build UI using React and TypeScript", "Frontend React Developer", 10000 },
                    { 3, "Work across backend and frontend systems", "Fullstack Developer", 15000 }
                });
